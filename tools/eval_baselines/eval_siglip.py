# Run directly from the repo root, e.g. `torchrun tools/eval_baselines/eval_siglip.py`: put the repo root on
...
from transformers import HfArgumentParser, AutoProcessor, AutoModel
