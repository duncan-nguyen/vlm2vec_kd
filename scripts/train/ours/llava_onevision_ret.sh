...
#
#   VARIANT=ours SEED=42 bash scripts/train/ours/llava_onevision_ret.sh
#   for v in ours student_only; do
#     for s in 42 43 44; do VARIANT=$v SEED=$s bash scripts/train/ours/llava_onevision_ret.sh; done
#   done
...
#   MMEB_TRAIN_DIR=/duong/dan/khac bash scripts/train/ours/llava_onevision_ret.sh
...
#
#   TASK=ret STUDENT=llava_onevision TEACHER_CACHE=cache/b3_qwen2_2b_llava_onevision_ret \
#     bash scripts/data/precompute_teacher_embeddings.sh
#   TEACHER_CACHE=cache/b3_qwen2_2b_llava_onevision_ret bash scripts/train/ours/llava_onevision_ret.sh
#
...
OUTPUT_DIR="${OUTPUT_DIR:-training/ours/llava_onevision_ret/${VARIANT}_seed${SEED}}"
...
# test:  bash scripts/train/ours/llava_onevision_ret.sh --percent_data 0.01 \
