#!/bin/bash
# Ours -- FastVLM-0.5B, visual grounding
...
#
#   VARIANT=ours SEED=42 bash scripts/train/ours/fastvlm_grounding.sh
#   for v in ours student_only; do
#     for s in 42 43 44; do VARIANT=$v SEED=$s bash scripts/train/ours/fastvlm_grounding.sh; done
#   done
...
#   MMEB_TRAIN_DIR=/duong/dan/khac bash scripts/train/ours/fastvlm_grounding.sh
...
#
#   TASK=grounding STUDENT=fastvlm TEACHER_CACHE=cache/b3_qwen2_2b_fastvlm_grounding \
#     bash scripts/data/precompute_teacher_embeddings.sh
#   TEACHER_CACHE=cache/b3_qwen2_2b_fastvlm_grounding bash scripts/train/ours/fastvlm_grounding.sh
#
...
OUTPUT_DIR="${OUTPUT_DIR:-training/ours/fastvlm_grounding/${VARIANT}_seed${SEED}}"
...
# test:  bash scripts/train/ours/fastvlm_grounding.sh --percent_data 0.01 \
