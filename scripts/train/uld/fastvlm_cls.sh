#!/bin/bash
# Universal logit distillation -- FastVLM-0.5B, CLS
...
#   MMEB_TRAIN_DIR=/duong/dan/khac bash scripts/train/uld/fastvlm_cls.sh
...
OUTPUT_DIR="${OUTPUT_DIR:-training/uld_fastvlm_cls}"
SEED="${SEED:-42}"
...
#   TEACHER_CACHE=cache/b3_qwen2_2b_fastvlm_cls bash scripts/train/uld/fastvlm_cls.sh
#
...
# one flag away:  bash scripts/train/uld/fastvlm_cls.sh --percent_data 0.01
