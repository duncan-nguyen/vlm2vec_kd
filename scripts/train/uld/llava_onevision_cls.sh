#!/bin/bash
# Universal logit distillation -- LLaVA-OneVision-0.5B, CLS
...
#   MMEB_TRAIN_DIR=/duong/dan/khac bash scripts/train/uld/llava_onevision_cls.sh
...
OUTPUT_DIR="${OUTPUT_DIR:-training/uld_llava_onevision_cls}"
SEED="${SEED:-42}"
...
#   TEACHER_CACHE=cache/b3_qwen2_2b_llava_onevision_cls bash scripts/train/uld/llava_onevision_cls.sh
#
...
# one flag away:  bash scripts/train/uld/llava_onevision_cls.sh --percent_data 0.01
