#!/bin/bash
# Proposal + projector CKA -- FastVLM-0.5B, VQA
...
#   MMEB_TRAIN_DIR=/duong/dan/khac bash scripts/train/pproj/fastvlm_vqa.sh
...
OUTPUT_DIR="${OUTPUT_DIR:-training/pproj_fastvlm_vqa}"
SEED="${SEED:-42}"
...
# one flag away:  bash scripts/train/pproj/fastvlm_vqa.sh --percent_data 0.01
