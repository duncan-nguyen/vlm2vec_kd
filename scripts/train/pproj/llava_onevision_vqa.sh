#!/bin/bash
# Proposal + projector CKA -- LLaVA-OneVision-0.5B, VQA
...
#   MMEB_TRAIN_DIR=/duong/dan/khac bash scripts/train/pproj/llava_onevision_vqa.sh
...
OUTPUT_DIR="${OUTPUT_DIR:-training/pproj_llava_onevision_vqa}"
SEED="${SEED:-42}"
...
# one flag away:  bash scripts/train/pproj/llava_onevision_vqa.sh --percent_data 0.01
