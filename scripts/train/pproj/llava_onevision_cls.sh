#!/bin/bash
# Proposal + projector CKA -- LLaVA-OneVision-0.5B, CLS
...
# ! as -(num_pad + 1) (src/criterions/propose_with_proj.py), which is the right-padded
...
#   MMEB_TRAIN_DIR=/duong/dan/khac bash scripts/train/pproj/llava_onevision_cls.sh
...
OUTPUT_DIR="${OUTPUT_DIR:-training/pproj_llava_onevision_cls}"
SEED="${SEED:-42}"
...
# one flag away:  bash scripts/train/pproj/llava_onevision_cls.sh --percent_data 0.01
