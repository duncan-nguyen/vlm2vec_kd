#!/bin/bash
# Proposal + soft-DTW -- FastVLM-0.5B, CLS
...
#   MMEB_TRAIN_DIR=/duong/dan/khac bash scripts/train/pdtw/fastvlm_cls.sh
...
OUTPUT_DIR="${OUTPUT_DIR:-training/pdtw_fastvlm_cls}"
SEED="${SEED:-42}"
...
# one flag away:  bash scripts/train/pdtw/fastvlm_cls.sh --percent_data 0.01
