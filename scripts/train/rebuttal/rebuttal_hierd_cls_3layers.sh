...
#   MMEB_TRAIN_DIR=/duong/dan/khac bash scripts/train/rebuttal/rebuttal_hierd_cls_3layers.sh
...
torchrun --standalone \
    ...
    --percent_data 1.0 \
    --output_dir "training/rebuttal_hierd_cls_3_layers" \
    ...
    --teacher_layer_mapping 0 25 28 \
    --student_layer_mapping 0 21 24 \
