...
#   MMEB_TRAIN_DIR=/duong/dan/khac bash scripts/train/rebuttal/rebuttal_hierd_cls_min_cluster_4.sh
...
torchrun --standalone \
    ...
    --percent_data 1.0 \
    --output_dir "training/rebuttal_hierd_cls_min_cluster_4" \
