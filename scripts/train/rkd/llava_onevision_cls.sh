...
#   MMEB_TRAIN_DIR=/duong/dan/khac bash scripts/train/rkd/llava_onevision_cls.sh
...
OUTPUT_DIR="${OUTPUT_DIR:-training/rkd_llava_onevision_cls}"
SEED="${SEED:-42}"
...
#   TEACHER_CACHE=cache/b3_qwen2_2b_llava_onevision_cls bash scripts/train/rkd/llava_onevision_cls.sh
#
...
# one flag away:  bash scripts/train/rkd/llava_onevision_cls.sh --percent_data 0.01
