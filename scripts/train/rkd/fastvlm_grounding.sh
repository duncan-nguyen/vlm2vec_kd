#!/bin/bash
# RKD -- FastVLM-0.5B, visual grounding
...
# Data:    MSCOCO grounding, 100K rows; see docs/datasets.md
...
#   MMEB_TRAIN_DIR=/duong/dan/khac bash scripts/train/rkd/fastvlm_grounding.sh
...
OUTPUT_DIR="${OUTPUT_DIR:-training/rkd_fastvlm_grounding}"
SEED="${SEED:-42}"
...
#   TEACHER_CACHE=cache/b3_qwen2_2b_fastvlm_grounding bash scripts/train/rkd/fastvlm_grounding.sh
#
...
# one flag away:  bash scripts/train/rkd/fastvlm_grounding.sh --percent_data 0.01
