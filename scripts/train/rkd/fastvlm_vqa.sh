...
#   MMEB_TRAIN_DIR=/duong/dan/khac bash scripts/train/rkd/fastvlm_vqa.sh
...
OUTPUT_DIR="${OUTPUT_DIR:-training/rkd_fastvlm_vqa}"
SEED="${SEED:-42}"
...
#   TEACHER_CACHE=cache/b3_qwen2_2b_fastvlm_vqa bash scripts/train/rkd/fastvlm_vqa.sh
#
...
# one flag away:  bash scripts/train/rkd/fastvlm_vqa.sh --percent_data 0.01
