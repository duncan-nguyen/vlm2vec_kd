...
# Data:    the 8 IND retrieval subsets, about 595K rows; see docs/datasets.md
...
#   MMEB_TRAIN_DIR=/duong/dan/khac bash scripts/train/rkd/llava_onevision_ret.sh
...
OUTPUT_DIR="${OUTPUT_DIR:-training/rkd_llava_onevision_ret}"
SEED="${SEED:-42}"
...
#   TEACHER_CACHE=cache/b3_qwen2_2b_llava_onevision_ret bash scripts/train/rkd/llava_onevision_ret.sh
#
...
# one flag away:  bash scripts/train/rkd/llava_onevision_ret.sh --percent_data 0.01
