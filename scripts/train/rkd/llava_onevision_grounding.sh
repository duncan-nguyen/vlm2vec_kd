#!/bin/bash
# RKD -- LLaVA-OneVision-0.5B, visual grounding
...
#   MMEB_TRAIN_DIR=/duong/dan/khac bash scripts/train/rkd/llava_onevision_grounding.sh
...
OUTPUT_DIR="${OUTPUT_DIR:-training/rkd_llava_onevision_grounding}"
SEED="${SEED:-42}"
...
#   TEACHER_CACHE=cache/b3_qwen2_2b_llava_onevision_grounding bash scripts/train/rkd/llava_onevision_grounding.sh
#
...
# one flag away:  bash scripts/train/rkd/llava_onevision_grounding.sh --percent_data 0.01
