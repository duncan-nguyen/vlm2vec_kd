...
#   MMEB_TRAIN_DIR=/duong/dan/khac bash scripts/train/rkd/fastvlm_ret.sh
...
OUTPUT_DIR="${OUTPUT_DIR:-training/rkd_fastvlm_ret}"
SEED="${SEED:-42}"
...
#   TEACHER_CACHE=cache/b3_qwen2_2b_fastvlm_ret bash scripts/train/rkd/fastvlm_ret.sh
#
...
# one flag away:  bash scripts/train/rkd/fastvlm_ret.sh --percent_data 0.01
