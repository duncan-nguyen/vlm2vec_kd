...
#   MMEB_TRAIN_DIR=/duong/dan/khac bash scripts/train/emo/llava_onevision_vqa.sh
...
OUTPUT_DIR="${OUTPUT_DIR:-training/emo_llava_onevision_vqa}"
SEED="${SEED:-42}"
...
# one flag away:  bash scripts/train/emo/llava_onevision_vqa.sh --percent_data 0.01
